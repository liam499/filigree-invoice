...
This came out of broader research we'd been on — AI input integrity, hidden-data
layers, steganalysis. The invoice application turned out to be the cleanest
specialisation of the primitive, and rather than commercialise it ourselves,
